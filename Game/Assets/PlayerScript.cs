...
public class PlayerScript : MonoBehaviour
{
    ...
    public void ConsumirItem()
    {
        ...
        //vidaAtual = Mathf.Min(vidaAtual, vidaMaxima); // Garante que a vida n�o ultrapasse o m�ximo
        //AtualizaHealthBar();
    ...
    {
        vidaAtual -= dano;
        vidaAtual = Mathf.Max(0, vidaAtual); // Garante que a vida n�o seja negativa
        AtualizaHealthBar();

        if (vidaAtual <= 0)
        {
            // Implemente l�gica de morte do jogador
